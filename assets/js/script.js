...
const months = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "June", "Julho",
                        ...
                        <div class="bottom-content">
                            ...
                            <div class="settings">
                                ...
                                <ul class="menu">
                                    ...
                                    <li onclick="deleteNote(${id})"><i class="uil uil-trash"></i>Remover</li>
                                </ul>
                            </div>
                        </div>
                    </li>`;
...
function deleteNote(noteId) {
    let confirmDel = confirm("Deseja remover essa anotação?");
